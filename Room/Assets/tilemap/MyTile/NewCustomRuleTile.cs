...
public class NewCustomRuleTile : RuleTile<NewCustomRuleTile.Neighbor> {
    ...
    {
        // alwaysConnect가 활성화 되어있으면,
        // 배열에 타일이 포함되어 있거나 타일이 같을때 true 반환
        // 활성화 되어 있지 않으면 타일이 같을 때 true 반환
    ...
    {
        // checkSelf가 활성화 되어 있으면 tile이 존재할 때 true 반환
        // 활성화 되어 있지 않으면 tile이 존재하고, tile이 다를 때 true 반환
